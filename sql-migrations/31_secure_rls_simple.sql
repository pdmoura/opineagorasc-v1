...
BEGIN
    ...
    RAISE NOTICE 'Politicas existentes removidas';
EXCEPTION
    WHEN others THEN
        RAISE NOTICE 'Algumas políticas não existiam';
END $$;

-- 2. Criar políticas restritivas
...
-- 4. Criar trigger para rate limiting
